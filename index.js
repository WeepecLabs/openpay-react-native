...
export default class Openpay extends Component {
  ...
  validateProps = (props) => {
    ...
    if (!props.hasOwnProperty('isProductionMode') || !props.hasOwnProperty('load') || !props.hasOwnProperty('merchantId') || !props.hasOwnProperty('publicKey') || !props.hasOwnProperty('successToken') || !props.hasOwnProperty('failToken')) {
      return false;
    }
